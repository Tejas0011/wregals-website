...
export default function AIChatbot({ visible, user, onSignInClick }: AIChatbotProps) {
    ...
    return (
        <>
                ...
                >
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            >
                                <iconify-icon icon="solar:star-shine-bold" width="16" style={{ color: '#D4AF37' }} />
                            </div>
                            <div>
                        ...
                        {messages.map((msg, i) => (
                            <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                                {msg.role === 'model' && (
                                    ...
                                    >
                                        <iconify-icon icon="solar:star-shine-bold" width="10" style={{ color: '#D4AF37' }} />
                                    </div>
                                )}
                                <div
                    ...
                    >
                        ...
                        >
                            <iconify-icon icon="solar:arrow-up-bold" width="14" />
                        </button>
                    </div>
                </div>
            )}
            ...
            >
                {open
                    ? <iconify-icon icon="solar:close-square-linear" width="22" />
                    : <iconify-icon icon="solar:star-shine-bold" width="22" />
                }
            </button>
